(function (namespace, $) {
	...
	p._handleMenuToggleClick = function (e) {
		...
		$.cookie('sidebar_closed', (state != AppNavigation.MENU_COLLAPSED) * 1, { expires: 30, path: '/' });
	};
	...
	global.materialadmin.AppNavigation = new AppNavigation;
}(global.materialadmin, jQuery)); // pass in (namespace, jQuery):